...
{
    "1,使用P10的DAC脚读取ADC数据！\r\
2,请自行准备一个跳线帽.\r\
3,将P10的RV1和DAC连接起来.\r\
4,调节RV1观看ADC读数变化！",
    "1,使用P10的DAC腳讀取ADC數據！\r\
2,請自行準備一個跳線帽.\r\
3,將P10的RV1和DAC連接起來.\r\
4,調節RV1觀看ADC讀數變化！",
    "1,Use P10 DAC pin read data!\r\
2,Prepare a jumper cap.\r\
3,Connect P10 DAC & RV1.\r\
...
uint8_t vmeter_play(void)
{
    ...
    gui_show_strmid(0, 0, lcddev.width, gui_phy.tbheight, WHITE, gui_phy.tbfsize, (uint8_t *)APP_MFUNS_CAPTION_TBL[27][gui_phy.language]); /* 显示标题 */
