...
#define KEY0_INT_GPIO_CLK_ENABLE()      do{ RCC->AHB4ENR |= 1 << 7; }while(0)   /* PH口时钟使能 */
...
#define KEY1_INT_GPIO_CLK_ENABLE()      do{ RCC->AHB4ENR |= 1 << 7; }while(0)   /* PH口时钟使能 */
#define KEY1_INT_IRQn                   EXTI2_IRQn
#define KEY1_INT_IRQHandler             EXTI2_IRQHandler

#define KEY2_INT_GPIO_PORT              GPIOC
#define KEY2_INT_GPIO_PIN               SYS_GPIO_PIN13
#define KEY2_INT_GPIO_CLK_ENABLE()      do{ RCC->AHB4ENR |= 1 << 2; }while(0)   /* PC口时钟使能 */
