...
{
    delay_ms(20);                   /* 消抖 */
    EXTI_D1->PR1 = KEY0_INT_GPIO_PIN;   /* 清除KEY0所在中断线 的中断标志位 */
...
{ 
    delay_ms(20);                   /* 消抖 */
    EXTI_D1->PR1 = KEY1_INT_GPIO_PIN;   /* 清除KEY1所在中断线 的中断标志位 */
...
{
    delay_ms(20);                   /* 消抖 */
    EXTI_D1->PR1 = KEY2_INT_GPIO_PIN;   /* 清除KEY2所在中断线 的中断标志位 */
...
{ 
    delay_ms(20);                   /* 消抖 */
    EXTI_D1->PR1 = WKUP_INT_GPIO_PIN;   /* 清除WKUP所在中断线 的中断标志位 */
