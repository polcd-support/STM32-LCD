...
#define KEY0_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 7; }while(0)   /* PH口时钟使能 */

#define KEY1_GPIO_PORT                  GPIOH
#define KEY1_GPIO_PIN                   SYS_GPIO_PIN2
#define KEY1_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 7; }while(0)   /* PH口时钟使能 */

#define KEY2_GPIO_PORT                  GPIOC
#define KEY2_GPIO_PIN                   SYS_GPIO_PIN13
#define KEY2_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 2; }while(0)   /* PC口时钟使能 */
