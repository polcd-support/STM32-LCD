...
#define PCF8574_INT_GPIO_CLK_ENABLE()       do{ RCC->AHB4ENR |= 1 << 1; }while(0)       /* IO口时钟使能 */

/******************************************************************************************/

#define PCF8574_INT     sys_gpio_pin_get(PCF8574_INT_GPIO_PORT, PCF8574_INT_GPIO_PIN)   /* PCF8574 INT脚 */
