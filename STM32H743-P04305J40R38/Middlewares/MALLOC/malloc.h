 ...
 * 以SRAMIN为例，size=448*1024+(474*1024/64)*4=500544≈487KB

 * 已知总内存容量(size)，最大内存池的计算公式如下：
 * MEM1_MAX_SIZE=(MEM1_BLOCK_SIZE*size)/(MEM1_BLOCK_SIZE+sizeof(MT_TYPE))
 * 以SRAM12为例,MEM1_MAX_SIZE=(64*256)/(64+4)=248.24KB≈240.9KB
 */
 
/* mem1内存参数设定.mem1是H7内部的AXI内存. */
#define MEM1_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM1_MAX_SIZE           430*1024                        /* 最大管理内存,H7的AXI内存总共512KB */
...
#define MEM3_MAX_SIZE           240 *1024                       /* 最大管理内存,H7的SRAM1+SRAM2共256KB */
#define MEM3_ALLOC_TABLE_SIZE   MEM3_MAX_SIZE/MEM3_BLOCK_SIZE   /* 内存表大小 */

/* mem4内存参数设定.mem4是H7内部的SRAM4内存 */
#define MEM4_BLOCK_SIZE         64                              /* 内存块大小为64字节 */
#define MEM4_MAX_SIZE           60 *1024                        /* 最大管理内存,H7的SRAM4共64KB */
...
#define MEM5_MAX_SIZE           120 *1024                       /* 最大管理内存,H7的DTCM共128KB */
...
#define MEM6_MAX_SIZE           60 *1024                        /* 最大管理内存K,H7的ITCM共64KB */
