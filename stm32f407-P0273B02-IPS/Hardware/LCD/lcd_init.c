...
//	ST7365P + 2.37寸 BOE IPS (P0273B02-IPS, 320x320) 初始化序列
	LCD_WR_REG(0x11);			//Sleep out
	delay_ms(150);

	LCD_WR_REG(0xF0);	LCD_WR_DATA(0xC3);	//Command2 BK0
	LCD_WR_REG(0xF0);	LCD_WR_DATA(0x96);

	LCD_WR_REG(0x3A);	LCD_WR_DATA(0x55);	//16bit/pixel (RGB565)
	LCD_WR_REG(0x36);	LCD_WR_DATA(0x40);	//MADCTL

	LCD_WR_REG(0xE8);	//Frame rate / power
	...
	LCD_WR_REG(0xC5);	LCD_WR_DATA(0x27);	//VCOM
	LCD_WR_REG(0xC2);	LCD_WR_DATA(0xA7);	//Power control
	...
	LCD_WR_REG(0x21);	LCD_WR_DATA(0x00);	//Display inversion on
